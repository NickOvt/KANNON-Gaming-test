...
function spin(arrayOfReels) {
  ...
  for (let i = 0; i < arrayOfReels.length; i++) {
    spinResult.push(
      arrayOfReels[i][Math.floor(Math.random() * arrayOfReels[i].length)]
    );
  }
...
function resultOfSpin(spinResult) {
  ...
  if (
    ...
    (spinResult[0] == 'cherry' && spinResult[1] == 'cherry') ||
    (spinResult[1] == 'cherry' && spinResult[2] == 'cherry')
  )
    coins = 40;
  else if (
    spinResult[0] == 'apple' &&
    ...
    (spinResult[0] == 'apple' && spinResult[1] == 'apple') ||
    (spinResult[1] == 'apple' && spinResult[2] == 'apple')
  )
    coins = 10;
  else if (
    spinResult[0] == 'banana' &&
    ...
    (spinResult[0] == 'banana' && spinResult[1] == 'banana') ||
    (spinResult[1] == 'banana' && spinResult[2] == 'banana')
  )
    coins = 5;
  else if (
    spinResult[0] == 'lemon' &&
